...
class SavedWordsUzAdapter(var list: List<WordData>) : Adapter<SavedWordsUzAdapter.WordViewHolder>(), TempAdapter {
    ...
    inner class WordViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind() {
            ...
            if (item.is_favourite == 2) save.setImageResource(R.drawable.ic_favourite_2)
